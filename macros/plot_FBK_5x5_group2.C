...
{
	map_plotter mp;
	mp.tag = "FBK_5x5_group2"; //This defines names of all output files
	...
	//conf 589
	mp.run_end = new vector<int>{54746}; 
	mp.run_start = new vector<int>{54564}; //54364

	//Define rotation angle and manual adjustments of x and y
	mp.angle = new vector<float>{-0.75}; //degrees
	mp.x_offset= new vector<float>{0.0115}; //mm
